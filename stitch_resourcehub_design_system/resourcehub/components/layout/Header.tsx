        ...
        <nav className="container-max flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="hidden md:inline-block bg-accent text-white text-sm font-semibold px-6 py-2.5 rounded-full hover:bg-accent-dark active:scale-95 transition-all duration-200 cursor-pointer"
            >
              Get a Quote
            </button>
            <button
          ...
          <ul className="flex flex-col bg-primary border-t border-white/10 px-4 pb-6 pt-2 gap-1">
            ...
            <li className="pt-4">
              <button
                ...
                className="w-full text-center bg-accent text-white font-semibold px-6 py-3 rounded-full hover:bg-accent-dark transition-colors duration-200"
              >
                Get a Quote
              </button>
            </li>
